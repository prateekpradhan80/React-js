...
const copyPasswordToClipboard=useCallback(()=>{
  ...
  useEffect(()=>{passwordGenerator()} , [length,numberAllowed,charAllowed, passwordGenerator,setPassword] )
  return (
    <div className="w-full max-w-md mx-auto shadow-md rounded-lg py-3 px-4 my-8 text-orange-500 bg-gray-700">
      ...
      <div className="flex shadow rounded-lg overflow-hidden mb-4">
        ...
        placeholder="password" readOnly ref={passwordRef} />
          ...
          <button onClick={copyPasswordToClipboard}  className="outline-none bg-orange-500 text-white px-3 py-0.5 shrink-0 hover:bg-sky-700">Copy</button>
